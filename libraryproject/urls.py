...
urlpatterns = [
    ...
    path('', library_views.HomeView.as_view(), name='home'),
    path('about/', library_views.about),
    path('book_description/<int:book_id>/',
         book_details, name='book_description'),
    path('book_details/<int:book_id>/', book_details,
         name='book_details'),  # Nueva URL para book_details
    path('change_availability/<int:book_id>/',
         views.change_availability, name='change_availability'),
    path('reserve_book/<int:book_id>/', views.reserve_book, name='reserve_book'),
    path('change_real_availability/<int:book_id>/',
         views.change_real_availability, name='change_real_availability'),
    path('verify_availability/<int:book_id>/',
         views.verify_availability, name='verify_availability'),
    ...
    path('rent_name/<int:book_id>/', library_views.rent_name,
         name='rent_name'),  # URL para procesar el alquiler del libro
    path('book_description/<int:book_id>/<str:username>/',
         views.confirm_rental, name='confirm_rental'),
    ...
    path('eliminar_usuario/<int:user_id>/',
